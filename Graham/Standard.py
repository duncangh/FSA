...
class Standardize:
    def __init__(self, sym, rf=1.5):
        ...
        self.current_liabilities = np.array(['CostsInExcessOfBillingsOnUncompletedContractsOrProgramsExpectedToBeCollectedWithinOneYear',
             ...
             'LongTermDebtCurrent'])
        self.interest_bearing = np.array(['LongTermDebtNoncurrent', 'LongTermDebtCurrent', 'DebtCurrent',
       'ShortTermBorrowings', 'LongTermDebtAndCapitalLeaseObligations',
       'LongTermDebt', 'CapitalLeaseObligationsNoncurrent',
       'DueToRelatedPartiesCurrent', 'CommercialPaper', 'SecuredDebt',
       'LineOfCredit', 'DueToAffiliateCurrent', 'UnsecuredDebt',
       'LongTermDebtAndCapitalLeaseObligationsCurrent',
       'SeniorLongTermNotes', 'ShortTermBankLoansAndNotesPayable',
       'OtherLongTermDebtNoncurrent', 'OtherBorrowings',
       'CapitalLeaseObligationsCurrent', 'LongTermNotesPayable',
       'ConvertibleLongTermNotesPayable', 'LongTermUnpaidClaims',
       'LoansPayableToBank', 'RecourseDebtNonCurrent',
       'NonRecourseDebtNonCurrent', 'OtherLongTermLiabilities',
       'RecourseDebtCurrent', 'SubordinatedDebtLongTermAffiliates',
       'NonRecourseDebtCurrent', 'ConvertibleNotesPayableCurrent',
       'SeniorNotesCurrent', 'LongTermLineOfCredit',
       'OtherShortTermBorrowings', 'FundsPayableAndAmountsDueToCustomers',
       'ConvertibleDebt', 'LiabilitiesOtherThanLongtermDebtNoncurrent',
       'SeniorNotes', 'CapitalizationLongtermDebtAndEquity',
       'ShortTermBorrowingsAndLongTermDebtCurrent',
       'DebtAndCapitalLeaseObligations', 'LongTermDebtFairValueDisclosure',
       ...
       'IntercompanyPayablesNoncurrent', 'JuniorSubordinatedLongTermNotes',
       'Intercompanyloanspayable', 'NotesPayableCurrent',
       'Intercompanyaccountspayable', 'CorporateDebt',
       'FacilityLeaseObligationNoncurrent', 'IntercompanyPayablesCurrent',
       ...
       'DueToParentAndSubsidiariesCurrentConsumerProducts',
       'LongTermLiabilitiesOther', 'NotesAndLoansPayableCurrent',
       'AccountsPayableRelatedPartiesCurrentAndNoncurrent',
       'OtherLongTermDebtCurrent',
       'LongTermDebtCurrentVariableInterestEntity',
       ...
       'AssetBackedSecuritiesDebtOwedToSecuritizationInvestorsCurrent',
       'LongTermDebtVariableInterestEntity',
       'OtherLiabilitiesOfConsolidatedVies',
       'OtherLongTermLiabilitiesAccruedPensionAndSelfInsuranceReservesNoncurrent',
       'IntercompanyAccountsPayableNoncurrent',
       'LoansPayableToBankCurrent',
       'LongTermDebtOfConsolidatedVariableInterestEntitiesNonCurrentAtFairValue',
       'CollateralPayableOnLoanedSecurities',
       'ShortTermDebtAndCapitalLeaseObligationsCurrent',
       'LongTermDebtFairValue',
       'CurrentMaturitiesOfLongTermDebtOfConsolidatedVariableInterestEntitiesAtFairValue',
       'ConvertibleDebtNoncurrent', 'SecuredLongTermDebt', 'NotesPayable',
       'ConvertibleDebtCurrent', 'LongTermLoansFromBank',
       ...
       'BookOverdrafts',
       'LongTermLiabilitiesHeldForSaleRelatingToDiscontinuedOperations',
       'PayablesToParentsCurrent'])
